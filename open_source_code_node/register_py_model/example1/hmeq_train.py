...
trainX = np.concatenate((trainX_intv, trainX_class_ohe), axis=1)
...
fullX = np.concatenate((fullX_intv, fullX_class_ohe), axis=1)
...
print('***** Helper strings when building score code *****')
print(', '.join(dm_input))
print('Output: ' + ', '.join(dm_predictionvar + [dm_classtarget_intovar]))
print(dm_input)
