...
Starting with the 2021.1.1 release of SAS Viya 4, the capability to productionalize these pipelines was incrementally added and full support to register them to [SAS Model Manager](https://support.sas.com/en/software/model-manager-support.html) is available from 2021.1.4 release. Note that this applies to the Python language and not R. Refer to the [blog post](https://blogs.sas.com/content/subconsciousmusings/2021/08/25/machine-learning-pipeline-using-sas-and-python/) and examples in register_pyonly_model, register_py_model, and register_py_preprocess folders for more details.
