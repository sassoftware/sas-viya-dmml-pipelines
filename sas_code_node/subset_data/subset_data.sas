...
/* Training Code */
/* Metadata change to set the role of filter for the specified filter */
/* variable. Enter the following into the Training Code pane: */
...
/* This example subsets the data to only include observations where */
/* JOB=Sales or JOB=Self. */
